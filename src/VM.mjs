...
export class VM {
  ...
  execute(instruction) {
    ...
    const actions = new Map([
      ...
      [
        'BST',
        () => (this.environment[parseInt(parts[1], 10)][parseInt(parts[2], 10)] = this.register.pop()),
      ],
      [
        'BLD',
        () => {
      ...
      [
        'GT',
        () => this.register.push(this.register.shift() > this.register.pop() ? 1 : 0),
      ],
      [
        'GTE',
        () => this.register.push(this.register.shift() - 1 >= this.register.pop() ? 1 : 0),
      ],
      [
        'LT',
        () => this.register.push(this.register.shift() < this.register.pop() ? 1 : 0),
  ...
  *instructionGenerator(instructions, startCounter = 0) {
  ...
  run(instructions) {
    ...
    let instructionIterator = this.instructionGenerator(instructions, this.programCounter)
    ...
    while (!result.done) {
        ...
        if (this.jumpOccurred) {
          instructionIterator = this.instructionGenerator(instructions, this.programCounter+1)
